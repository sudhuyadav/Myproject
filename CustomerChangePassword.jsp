...
<html>
    ...
    <body>
        <%
    String cusername=  session.getAttribute("customername").toString();
    
      Bean_Customer bc=new Bean_Customer();
      bc.setC_username(cusername);
         ...
         <div class="container-fluid">
            <div class="row">
             ...
             <div class="row">
                 ...
                 <div class="col-sm-4">
                     <form action="Code/CustomerChangePasswordCode.jsp" method="post">
                         ...
                         <input type="hidden" value="<%=cusername%>" name="username"/>
