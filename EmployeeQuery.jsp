<%-- 
    ...
    Created on : Apr 2, 2017, 3:23:15 PM
    Author     : S S YADAV
--%>
...
<html>
    <head>
        ...
        <title>Employee Query Page</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 text-center">
                    <span style="font-size: 30px;font-weight: bold">Employee Query Page</span>
                   <br/><br/> <br/><br/></div>
            ...
            <div class="row">
                <div class="col-sm-2"></div>  
                <div class="col-sm-5">
                    <form action="Code/EmployeeQueryCode.jsp" method="post">
                ...
                <div class="col-sm-3"><br/><br/><br/><br/>
                    <a href="ViewEmpAllQueryAnswer.jsp"><span class="text-danger" style="font-size: 20px;font-family: monospace">View Answer</span></a>
                </div>
                <div class="col-sm-2"></div>
            </div>
            <div class="row">
